				...
				<div class="il-mainbar">
					<div class="il-mainbar-triggers">
						<div class="il-mainbar-entries">
							<button class="btn btn-bulky" data-action="#" id="id_1" ><div class="icon custom small" aria-label=""><img src="" /></div><div><span class="bulky-label">TestEntry</span></div></button>
							<button class="btn btn-bulky" data-action="#" id="id_2" ><div class="icon custom small" aria-label=""><img src="" /></div><div><span class="bulky-label">TestEntry</span></div></button>
				...
				<div class="il-mainbar-slates">
					...
					<div class="il-mainbar-close-slates">
						<button class="btn btn-bulky" id="id_5" >
							<span class="glyph" href="#" aria-label="back"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span></span>
